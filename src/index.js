...
const commercialImages = [
  '20260602_112019.jpg', '20260602_111951.jpg', '20260507_181032.jpg', '20260507_145043.jpg',
  '20251219_150345.jpg', '20251112_153004.jpg', '20251112_152955.jpg', '20251106_153656.jpg',
  '20251104_164857.jpg', '20251028_085332.jpg', '20251018_181805.jpg', '20251009_182513.jpg',
  '20251008_135548.jpg', '20251008_134727.jpg', '20250806_115054.jpg', '20250805_154013.jpg',
  '20250805_154006.jpg', '20250805_153957.jpg', '20250724_185233.jpg', '20250723_100607.jpg',
  '20250716_140619.jpg', '20250626_145226.jpg', '20250603_165340.jpg', '20250603_142236.jpg',
  '20250324_105227.jpg', '20250313_105910.jpg', '20250305_110037.jpg', '20241112_162218.jpg',
  '20241007_060338.jpg', '20240308_152849.jpg', '20240307_155316.jpg', '20240307_131844.jpg'
];

const residentialImages = [
  'IMG-20260331-WA0045.jpg', '20260625_160259.jpg', '20260425_140807.jpg', '20260328_153251.jpg',
  '20260320_102956.jpg', '20260317_120124.jpg', '20260204_100907.jpg', '20260203_173954.jpg',
  '20260102_145358.jpg', '20251230_122827.jpg', '20251212_140251.jpg', '20251210_163909.jpg',
  '20251201_170315.jpg', '20251006_182709.jpg', '20251002_150102.jpg', '20250924_140845.jpg',
  '20250918_163101.jpg', '20250918_152624.jpg', '20250905_171655.jpg', '20250602_151124.jpg',
  '20250428_155143.jpg', '20250418_201046.jpg', '20250418_201034.jpg', '20250307_172805.jpg',
  '20250226_091025.jpg', '20250207_142731.jpg', '20250206_154400.jpg', '20241214_173945.jpg',
  '20241214_173941.jpg', '20241211_195003.jpg', '20241210_203345.jpg', '20241210_122424.jpg',
  '20240807_120622.jpg', '20240508_124617.jpg', '20240508_111829.jpg'
];

const projectGallery = (type, images) => `
  <div class="work-gallery" data-gallery="${type.toLowerCase()}">
    ${images.slice(0, 6).map((file, index) => `<div class="work-slot gallery-slot"><img src="/images/${type.toLowerCase()}/${file}" alt="${type} electrical project ${index + 1}"></div>`).join('')}
  </div>
`;
...
if (window.location.pathname.replace(/\/+$/, '') === '/work') {
  ...
  document.querySelectorAll('[data-gallery]').forEach((gallery) => {
    ...
    const images = category === 'commercial' ? commercialImages : residentialImages;
    const slots = [...gallery.querySelectorAll('.gallery-slot img')];
    let nextImage = slots.length;

    const changeImage = (slot, imageIndex) => {
      const usedSources = new Set(slots.map((image) => image.getAttribute('src')));
      let candidate = images[imageIndex % images.length];
      let candidateIndex = imageIndex % images.length;

      while (usedSources.has(`/images/${category}/${candidate}`)) {
        candidateIndex = (candidateIndex + 1) % images.length;
        candidate = images[candidateIndex];
      }

      slot.classList.add('is-changing');
      window.setTimeout(() => {
        slot.src = `/images/${category}/${candidate}`;
        slot.alt = `${category} electrical project`;
        slot.classList.remove('is-changing');
      }, 450);
    };

    slots.forEach((slot, index) => {
      const firstChange = 8000 + (index * 3000);
      window.setTimeout(() => {
        changeImage(slot, nextImage++);
        window.setInterval(() => changeImage(slot, nextImage++), 8000);
      }, firstChange);
    });
  });
}
